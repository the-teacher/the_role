...
describe Role do
  context "Role Create" do
    ...
    it "should init empty hash for role" do
  ...
  context "Role Update" do
    ...
    it "should create rule" do
      ...
      @role.has_role?(:articles, :index).should be_false
    end

    it "should create rule and set it ON" do
      @role.to_hash.should == {}
      @role.create_rule(:articles, :index)
      
      @role.has_role?(:articles, :index).should be_false
      
      @role.rule_on(:articles, :index)

      @role.has_role?(:articles, :index).should be_true
    end
  end
